...
@main
struct ReplayMigrationCheck {
    static func main() throws {
        let fileManager = FileManager.default
        for legacyApplicationName in ReplayMigration.legacyApplicationNames {
            ...
            let result = ReplayMigration.migrateDirectories(
        ...
        let legacySuiteName = "ReplayMigration.Legacy.\(UUID().uuidString)"
        let currentSuiteName = "ReplayMigration.Current.\(UUID().uuidString)"
